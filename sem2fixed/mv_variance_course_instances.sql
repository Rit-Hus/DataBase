DROP MATERIALIZED VIEW IF EXISTS mv_variance_course_instances;
CREATE MATERIALIZED VIEW mv_variance_course_instances AS
WITH instance_calculations AS (
    SELECT
    ...
    GROUP BY ci.course_instance_id, ci.instance_id, cl.course_code, p.period_name
)
SELECT
    instance_id,
    course_code,
